...
import { useUploadImages } from 'src/services/properties.service'

const UploadPropertyImagesDialog = ({ property, open, setOpen }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      for (let i = 0; i < filesArray.length; i++) {
        ...
        await uploadFiles.mutateAsync({ values: formData, propertyId: property?.id })
        handleClose()
      }
    } catch (error) {
...
export default UploadPropertyImagesDialog
