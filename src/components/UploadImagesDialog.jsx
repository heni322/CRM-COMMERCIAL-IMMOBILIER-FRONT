...
import { useUploadDocuments, useUploadImages } from 'src/services/residences.service'

const UploadImagesDialog = ({ data, open, setOpen, handleUploadImages }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      for (let i = 0; i < filesArray.length; i++) {
        ...
        await handleUploadImages({ values: formData, id: data?.id })
