...
const BlocAddDialog = ({ residence, open, handleCloseBloc }) => {
  ...
  return (
    <Dialog open={open} onClose={handleCloseBloc} maxWidth='md'>
      ...
      {/* <DialogActions>
        <Button onClick={handleCloseBloc} variant='contained' color='error' className='mr-1'>
          Close
        </Button>
      </DialogActions> */}
    </Dialog>
