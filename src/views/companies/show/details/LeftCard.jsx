...
const LeftCard = ({ folderData, hideEdit, hideDelete }) => {
  ...
  const state = states?.find(e => folderData?.state === e?.id)
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <CardContent sx={{ my: 1 }}>
            ...
            <Box sx={{ pt: 4 }}>
              <Box sx={{ pb: 4 }}>
                <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Avancement:</Typography>
              </Box>
          ...
          <CardContent>
            ...
            <Box sx={{ pt: 2, pb: 1 }}>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2' sx={{ textTransform: 'capitalize' }}>
                  {folderData?.ref_audit}
                </Typography>
              </Box>

              {folderData?.expected_start_date && (
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Date début prévue:</Typography>
                  <Typography variant='body2' sx={{ textTransform: 'capitalize' }}>
                    {folderData?.expected_start_date}
                  </Typography>
                </Box>
              ...
              {folderData?.start_date && (
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Date débute:</Typography>
                  <Typography variant='body2' sx={{ textTransform: 'capitalize' }}>
                    {folderData?.start_date}
                  </Typography>
                </Box>
              ...
              {folderData?.due_date && (
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Date fin:</Typography>
                  <Typography variant='body2' sx={{ textTransform: 'capitalize' }}>
                    {folderData?.due_date}
                  </Typography>
                </Box>
        ...
        >
          ...
          <DialogContent sx={{ pt: 8, pl: [6, 15], pr: [6, 15] }}>
            ...
            >
              ...
              <Button color='error' sx={{ mt: 2 }} variant='outlined' onClick={() => setSubscriptionDialogOpen(true)}>
                Cancel Subscription
              </Button>
            </Box>
          </DialogContent>
