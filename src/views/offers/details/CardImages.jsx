...
const CardImages = ({ property, handleOpen }) => {
    ...
    <div className='overflow-x-auto max-h-[400px]'>
      <table className='min-w-full divide-y divide-gray-200'>
        ...
        <tbody className='bg-white divide-y divide-gray-200'>
          <tr>
            <td className='px-6 py-2 whitespace-nowrap text-sm'>Image 1</td>
            {/* Show Type column on small screens only */}
            <td className='hidden sm:table-cell px-6 py-2 whitespace-nowrap text-sm'>JPEG</td>
            {/* Show Size column on small screens only */}
            <td className='hidden sm:table-cell px-6 py-2 whitespace-nowrap text-sm'>1,2 Mo</td>
