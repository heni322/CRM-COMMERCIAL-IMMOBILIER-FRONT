...
const SelectArticleDialog = ({ isDialogOpen, listArticles, selectedArticles, closeDialog, onSelectArticle }) => {
              ...
              <TableBody>
                {(Array.isArray(listArticles)?listArticles:(listArticles?.data??[])).map((article, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align='center'>
                      <CustomCurrency value={article?.registration_fees ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.registration_fees_compl ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.lotiss_fees ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.trustee_fees ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.folder_fees ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.lawyer_fees ?? 0} allowNegative={false} />
                    </TableCell>
                    <TableCell align='center'>
                      <CustomCurrency value={article?.others_fees ?? 0} allowNegative={false} />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
